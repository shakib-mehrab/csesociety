...
const ClubCard = ({ club }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-[#eaf2fa] via-[#f3f6fa] rounded-xl shadow-md border border-gray-200 hover:shadow-xl transition-shadow duration-300 flex flex-col overflow-hidden">
      {/* Club Logo Section */}
      ...
      <div className="p-6 flex-1 flex flex-col">
        <h3 className="text-2xl font-semibold text-[#01457e] mb-2">
          {club.name}
        </h3>
